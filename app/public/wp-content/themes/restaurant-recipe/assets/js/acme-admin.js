    ...
    at_document.ready( function() {
        ...
        function at_build_hide_unnecessary_meta() {
            var page_template = $('#page_template'),
                lrestaurant_recipe_template_builder_metabox = $('#restaurant_recipe_template_builder_metabox'),
                restaurant_recipe_sidebar_layout = $('#restaurant_recipe_sidebar_layout'),
                restaurant_recipe_meta_fields = $('#restaurant_recipe_meta_fields'),
            ...
            if( valueSelected === 'page-templates/template-builder.php' ){
                lrestaurant_recipe_template_builder_metabox.removeClass('hidden');
                restaurant_recipe_sidebar_layout.addClass('hidden');
                restaurant_recipe_meta_fields.addClass('hidden');
                postimagediv.addClass('hidden');
            }
            else{
                lrestaurant_recipe_template_builder_metabox.addClass('hidden');
                restaurant_recipe_sidebar_layout.removeClass('hidden');
                restaurant_recipe_meta_fields.removeClass('hidden');
