jQuery(function($){
	...
	$('.recent-blog-content-wrapper .hentry-inner').matchHeight();
...
// Enable menuToggle.
 ...
 ( function() {
        ...
        $( '.menu-toggle, .dropdown-toggle, .search-field, #site-navigation, #search-container' ).on( 'click', function( e ) {
