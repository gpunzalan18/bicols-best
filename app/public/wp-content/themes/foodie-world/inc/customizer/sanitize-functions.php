 ...
 */
function foodie_world_sanitize_select( $input, $setting ) {
 ...
 */
function foodie_world_sanitize_checkbox( $checked ) {
    // Boolean check.
 ...
 */
function foodie_world_sanitize_post( $input ) {
 ...
 */
function foodie_world_sanitize_image( $image, $setting ) {
    /*
 ...
 */
function foodie_world_sanitize_category_list( $input ) {
 ...
 *                    the setting default.
 */
function foodie_world_sanitize_number_range( $number, $setting ) {
