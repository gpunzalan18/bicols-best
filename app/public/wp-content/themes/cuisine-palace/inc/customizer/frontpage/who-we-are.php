<?php
/**
 * This file has the settings and options for the frontpage who we are section.
 *
...
if ( ! function_exists( 'cuisine_palace_customizer_frontpage_who_we_are' ) ) {

	/**
	 * This adds the section and controls for the frontpage who we are option.
	 *
	 * @param object $wp_customize WordPress customizer objects.
	 */
	function cuisine_palace_customizer_frontpage_who_we_are( $wp_customize ) {
	...
	add_action( 'customize_register', 'cuisine_palace_customizer_frontpage_who_we_are' );
}
