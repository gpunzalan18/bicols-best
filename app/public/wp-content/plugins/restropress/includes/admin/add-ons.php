					...
					<div class="inside">
						...
						<div class="rpress-purchased-wrap">
							...
							<div class="rpress-license-wrapper <?php echo $updated_class; ?>">
								...
								<button data-action="rpress_activate_addon_license" class="button button-medium button-primary pull-right rpress-validate-license"><?php echo __('Activate License', 'restropress'); ?></button>
								<div class="clear"></div>
							...
							<div class="rpress-license-deactivate-wrapper <?php echo $deactive_class; ?>">
								<button data-action="rpress_deactivate_addon_license" class="button  pull-left rpress-deactivate-license"><?php echo __('Deactivate License', 'restropress'); ?></button>
							</div>
