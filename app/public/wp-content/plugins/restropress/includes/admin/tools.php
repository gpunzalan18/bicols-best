...
function rpress_tools_import_export_display() {
	...
	<div class="postbox rpress-import-fooditems">
		<h3><span><?php _e( 'Import Food Items', 'restropress' ); ?></span></h3>
		<div class="inside">
			<p><?php _e( 'Import a CSV file of Food Items.', 'restropress' ); ?></p>
			<form id="rpress-import-fooditems" class="rpress-import-form rpress-import-export-form" action="<?php echo esc_url( add_query_arg( 'rpress_action', 'upload_import_file', admin_url() ) ); ?>" method="post" enctype="multipart/form-data">
				...
				<div class="rpress-import-options" id="rpress-import-fooditems-options" style="display:none;">
					...
					<table class="widefat rpress_repeatable_table striped" width="100%" cellpadding="0" cellspacing="0">
						<thead>
							<tr>
								<th><strong><?php _e( 'Product Field', 'restropress' ); ?></strong></th>
								<th><strong><?php _e( 'CSV Column', 'restropress' ); ?></strong></th>
								<th><strong><?php _e( 'Data Preview', 'restropress' ); ?></strong></th>
							</tr>
						</thead>
						<tbody>
							<tr>
								<td><?php _e( 'Product Author', 'restropress' ); ?></td>
								<td>
							...
							<tr>
								<td><?php _e( 'Product Categories', 'restropress' ); ?></td>
								<td>
							...
							<tr>
								<td><?php _e( 'Product Addons', 'restropress' ); ?></td>
								<td>
							...
							<tr>
								<td><?php _e( 'Product Creation Date', 'restropress' ); ?></td>
								<td>
							...
							<tr>
								<td><?php _e( 'Product Description', 'restropress' ); ?></td>
								<td>
							...
							<tr>
								<td><?php _e( 'Product Excerpt', 'restropress' ); ?></td>
								<td>
							...
							<tr>
								<td><?php _e( 'Product Image', 'restropress' ); ?></td>
								<td>
							...
							<tr>
								<td><?php _e( 'Product Notes', 'restropress' ); ?></td>
								<td>
							...
							<tr>
								<td><?php _e( 'Product Price(s)', 'restropress' ); ?></td>
								<td>
							...
							<tr>
								<td><?php _e( 'Product SKU', 'restropress' ); ?></td>
								<td>
							...
							<tr>
								<td><?php _e( 'Product Slug', 'restropress' ); ?></td>
								<td>
							...
							<tr>
								<td><?php _e( 'Product Status', 'restropress' ); ?></td>
								<td>
							...
							<tr>
								<td><?php _e( 'Product Tags', 'restropress' ); ?></td>
								<td>
							...
							<tr>
								<td><?php _e( 'Product Title', 'restropress' ); ?></td>
								<td>
							...
							<tr>
								<td><?php _e( 'Download Files', 'restropress' ); ?></td>
								<td>
							...
							<tr>
								<td><?php _e( 'File Download Limit', 'restropress' ); ?></td>
								<td>
							...
							<tr>
								<td><?php _e( 'Sale Count', 'restropress' ); ?></td>
								<td>
							...
							<tr>
								<td><?php _e( 'Total Earnings', 'restropress' ); ?></td>
								<td>
