  ...
  <div class="rpress-pickup-time-wrap rpress-time-wrap">
    ...
    ?>
	  <div class="pickup-date-text">
        <?php echo apply_filters( 'rpress_pickup_date_string', esc_html_e( 'Enter a pickup date', 'restropress' ) ); ?>
      </div>
	  
	  <textarea placeholder="<?php esc_html_e('mm/dd/yyyy', 'restropress') ?>" rows="2" class="rp-col-md-12 special-instructions custom-pickup-date" name="custom-pickup-date"><?php echo $current_date; ?></textarea>
