...
<div class="container-fluid rp-header">
	<div class="rp-row rp-customer-receipt">
	    ...
	    <p class="rp-center rp-order-head-text" id="save-order-no-msg"><?php _e( "Please save this receipt for your records.", 'restropress' ); ?></p>
...
<div id="rp-order-details">
  <div class="rp-row">
    <div class="rp-col-lg-3 rp-col-md-6 rp-col-sm-12">
      <div class="rp-order-section">
        <?php if ( filter_var( $rpress_receipt_args['date'], FILTER_VALIDATE_BOOLEAN ) ) : ?>
          <!-- <h3><?php _e( 'Order Info', 'restropress' ); ?></h3> -->
          <h3 class="rp-order-no-text"><?php _e( 'Order: ', 'restropress');  ?> <span>#<?php echo rpress_get_payment_number( $payment->ID ); ?></span></h3>
          <div class="rp-detils-content">
          <p><?php _e( 'Date', 'restropress' ); ?> : <span><?php echo date_i18n( get_option( 'date_format' ), strtotime( $meta['date'] ) ); ?></span></p>
          <p><?php _e( 'Name', 'restropress' ); ?> : <span><?php echo $firstname . ' ' . $lastname; ?></span></p>
            ...
            <!-- <p><?php _e( 'Status', 'restropress' ); ?> : <span><?php echo ucfirst( $order_status ); ?></span></p> -->
            ...
            echo sprintf( __( '%s', 'restropress' ), ucfirst( $service_label ) );?> : <span><?php echo rpress_local_date( $service_date ); ?></span>,

             <span><?php /* translators: %s : Service time */ echo $service_time; ?></span>
             <br>
            </p>
          </div>
        <?php endif; ?>
